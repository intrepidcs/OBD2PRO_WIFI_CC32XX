...
typedef const xdc_Char *__CARRAY1_ti_uia_loggers_LoggerStopMode_Instance_State__hdr;
...
typedef const xdc_Char *__CARRAY1_ti_uia_loggers_LoggerStopMode_Instance_State__packetArray;
...
struct ti_uia_loggers_LoggerStopMode_Fxns__ {
    ...
    xdc_Bool (*enable)(ti_uia_loggers_LoggerStopMode_Handle __inst);
    xdc_Bool (*disable)(ti_uia_loggers_LoggerStopMode_Handle __inst);
    xdc_Void (*write0)(ti_uia_loggers_LoggerStopMode_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid);
    xdc_Void (*write1)(ti_uia_loggers_LoggerStopMode_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1);
    xdc_Void (*write2)(ti_uia_loggers_LoggerStopMode_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2);
    xdc_Void (*write4)(ti_uia_loggers_LoggerStopMode_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4);
    xdc_Void (*write8)(ti_uia_loggers_LoggerStopMode_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8);
    xdc_Void (*setFilterLevel)(ti_uia_loggers_LoggerStopMode_Handle __inst, xdc_runtime_Diags_Mask mask, xdc_runtime_Diags_EventLevel filterLevel);
    xdc_runtime_Diags_Mask (*getFilterLevel)(ti_uia_loggers_LoggerStopMode_Handle __inst, xdc_runtime_Diags_EventLevel level);
    ti_uia_runtime_IUIATransfer_TransferType (*getTransferType)(ti_uia_loggers_LoggerStopMode_Handle __inst);
    xdc_Bool (*getContents)(ti_uia_loggers_LoggerStopMode_Handle __inst, xdc_Ptr hdrBuf, xdc_SizeT size, xdc_SizeT* cpSize);
    xdc_Bool (*isEmpty)(ti_uia_loggers_LoggerStopMode_Handle __inst);
    xdc_SizeT (*getMaxLength)(ti_uia_loggers_LoggerStopMode_Handle __inst);
    xdc_UInt16 (*getInstanceId)(ti_uia_loggers_LoggerStopMode_Handle __inst);
    ti_uia_runtime_IUIATransfer_Priority (*getPriority)(ti_uia_loggers_LoggerStopMode_Handle __inst);
    xdc_Void (*setPriority)(ti_uia_loggers_LoggerStopMode_Handle __inst, ti_uia_runtime_IUIATransfer_Priority priority);
    xdc_Void (*reset)(ti_uia_loggers_LoggerStopMode_Handle __inst);
    xdc_Void (*writeMemoryRange)(ti_uia_loggers_LoggerStopMode_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_UInt32 snapshotId, xdc_IArg fileName, xdc_IArg LineNum, xdc_IArg fmt, xdc_IArg startAdrs, xdc_UInt32 lengthInMAUs);
...
__extern xdc_Void ti_uia_loggers_LoggerStopMode_Instance_init__E(ti_uia_loggers_LoggerStopMode_Object *__obj, const ti_uia_loggers_LoggerStopMode_Params *__prms);
...
static inline ti_uia_loggers_LoggerStopMode_Handle ti_uia_loggers_LoggerStopMode_Handle_downCast(ti_uia_runtime_ILoggerSnapshot_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&ti_uia_loggers_LoggerStopMode_Module__FXNS__C ? (ti_uia_loggers_LoggerStopMode_Handle)i : (ti_uia_loggers_LoggerStopMode_Handle)0;
}
...
static inline xdc_Bool ti_uia_loggers_LoggerStopMode_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_uia_loggers_LoggerStopMode_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_uia_loggers_LoggerStopMode_Module_getMask( void ) 
{
    return ti_uia_loggers_LoggerStopMode_Module__diagsMask__C != NULL ? *ti_uia_loggers_LoggerStopMode_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_uia_loggers_LoggerStopMode_Module_setMask(xdc_Bits16 mask)
{
    if (ti_uia_loggers_LoggerStopMode_Module__diagsMask__C != NULL) {
