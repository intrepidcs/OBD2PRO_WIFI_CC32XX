...
typedef const xdc_Char *__CARRAY1_ti_uia_loggers_LoggerMin_Module_State__packetBuffer;
...
__extern xdc_Ptr ti_uia_loggers_LoggerMin_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
