...
typedef const ti_uia_runtime_IUIATransfer_Handle *__CARRAY1_ti_uia_services_Rta_Module_State__loggers;
...
static inline xdc_Bool ti_uia_services_Rta_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_uia_services_Rta_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_uia_services_Rta_Module_getMask( void ) 
{
    return ti_uia_services_Rta_Module__diagsMask__C != NULL ? *ti_uia_services_Rta_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_uia_services_Rta_Module_setMask(xdc_Bits16 mask)
{
    if (ti_uia_services_Rta_Module__diagsMask__C != NULL) {
