...
struct ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Fxns__ {
    ...
    xdc_IArg (*enter)(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle __inst);
    xdc_Void (*leave)(ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle __inst, xdc_IArg key);
...
static inline ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    if (ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Proxy__abstract__S()) {
        return (ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle)i;
    }
    return (const void*)i2->__fxns == (const void*)ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Proxy__delegate__S() ? (ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle)i : (ti_uia_family_c64p_GemTraceSync_Module_GateProxy_Handle)0;
}
