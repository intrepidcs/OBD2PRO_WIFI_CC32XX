...
static inline ti_uia_family_dm_TimestampDM816XTimer_Module_GateProxy_Handle ti_uia_family_dm_TimestampDM816XTimer_Module_GateProxy_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)ti_uia_family_dm_TimestampDM816XTimer_Module_GateProxy_Proxy__delegate__S() ? (ti_uia_family_dm_TimestampDM816XTimer_Module_GateProxy_Handle)i : (ti_uia_family_dm_TimestampDM816XTimer_Module_GateProxy_Handle)0;
}
